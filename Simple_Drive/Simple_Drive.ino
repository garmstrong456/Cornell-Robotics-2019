...
void loop() 
{
  ...
  Serial2.printf("$J = G21 G91 X%d Y%d F%d", driveDistance, driveDistance, dashSpeed);
  Serial2.print("\r\n\r\n");
  ...
  Serial2.printf("$J = G21 G91 X%d Y%d F%d", -driveDistance, -driveDistance, backingSpeed);
  Serial2.print("\r\n\r\n");
  delay(2*pauseTime);
}   
